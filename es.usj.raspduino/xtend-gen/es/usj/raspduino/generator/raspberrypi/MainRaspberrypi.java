...
import es.usj.raspduino.generator.raspberrypi.ActuatorLibrary;
import es.usj.raspduino.generator.raspberrypi.MainFileStructure;
import es.usj.raspduino.generator.raspberrypi.Schedule;
import es.usj.raspduino.generator.raspberrypi.SensorLibrary;
...
public class MainRaspberrypi {
  public void generateMainCode(final Model model, final Util util) {
    ...
    if (_not) {
      ...
      _schedule.generateCode(model, util);
    }
  }
}
